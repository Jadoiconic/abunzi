                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        while ($data = mysqli_fetch_array($qry)) { ?>
                            ...
                            <form action="./actions/handleUpdateDoc.php" class="col-md-6 col-sm-12" method="post">
                                <div class="modal-body">
                                    <div class="px-2">
                                        <div>
                                            <label for="fname">plaintiff Name</label>
                                            <input requied type="text" value="<?php print($data['ownder'])?>" name="pfname" class="form-control">
                                        </div>
                                        <div>
                                            <label for="lname">Defender Name</label>
                                            <input requied type="text" value="<?php print($data['defender'])?>" name="dfname" class="form-control">
                                        </div>
                                        <div>
                                            <label for="email">Problem</label>
                                            <input requied type="text" value="<?php print($data['title'])?>" name="problem" class="form-control">
                                        </div>
                                        <div>
